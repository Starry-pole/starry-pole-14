...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<bool> AhelpAdminPrefix =
        CVarDef.Create("ahelp.admin_prefix", true, CVar.SERVERONLY); // Starry Pole edit
    ...
    public static readonly CVarDef<bool> AhelpAdminPrefixWebhook =
        CVarDef.Create("ahelp.admin_prefix_webhook", true, CVar.SERVERONLY); // Starry Pole edit
}
